...
df_fc_ch0,_,df_cnn_ch0,columns_cnn =  features_creation(path_ch0,sr = None, duration = 0.3,
                                               mono = False,mfccs_num = 128,hop_length = 512)
df_fc_ch1,_,df_cnn_ch1,_ =  features_creation(path_ch1,sr = None, duration = 0.3,
                                                mono = False,mfccs_num = 128,hop_length = 512)
df_fc_ch2,_,df_cnn_ch2,_ =  features_creation(path_ch2,sr = None, duration = 0.3,
                                                mono = False,mfccs_num = 128,hop_length = 512)
df_fc_ch3,_,df_cnn_ch3,_ =  features_creation(path_ch3,sr = None, duration = 0.3,
                                                mono = False,mfccs_num = 128,hop_length = 512)
...
checkpointer_rnn_ch0 = ModelCheckpoint(filepath='d:/Project/Weights/RNN/weights_rnn_ch0.hdf5',
                               monitor='val_accuracy',
                               verbose=1,
                               save_best_only=True)

checkpointer_rnn_ch1 = ModelCheckpoint(filepath='d:/Project/Weights/RNN/weights_rnn_ch1.hdf5',
                               monitor='val_accuracy',
                               verbose=1,
                               save_best_only=True)

checkpointer_rnn_ch2 = ModelCheckpoint(filepath='d:/Project/Weights/RNN/weights_rnn_ch2.hdf5',
                               monitor='val_accuracy',
                               verbose=1,
                               save_best_only=True)

checkpointer_rnn_ch3 = ModelCheckpoint(filepath='d:/Project/Weights/RNN/weights_rnn_ch3.hdf5',
                               monitor='val_accuracy',
                               verbose=1,
                               save_best_only=True)
...
for i in range(4):
    print(f'channel{i}')
    model_rnn_branch.load_weights(f'd:/Project/Weights/RNN/weights_rnn_ch{i}.hdf5')
